...
const uint32_t token_flags_map[TOKEN_TYPE_COUNT] = {
		...
		[TOKEN_TYPE_FUNC_SIN] = TOKEN_FLAG_PREFIX | TOKEN_FLAG_IMPL_MULT_BEFORE,
		[TOKEN_TYPE_FUNC_COS] = TOKEN_FLAG_PREFIX | TOKEN_FLAG_IMPL_MULT_BEFORE,
		[TOKEN_TYPE_FUNC_TAN] = TOKEN_FLAG_PREFIX | TOKEN_FLAG_IMPL_MULT_BEFORE,
		[TOKEN_TYPE_FUNC_ASIN] = TOKEN_FLAG_PREFIX | TOKEN_FLAG_IMPL_MULT_BEFORE,
		[TOKEN_TYPE_FUNC_ACOS] = TOKEN_FLAG_PREFIX | TOKEN_FLAG_IMPL_MULT_BEFORE,
		[TOKEN_TYPE_FUNC_ATAN] = TOKEN_FLAG_PREFIX | TOKEN_FLAG_IMPL_MULT_BEFORE,
		[TOKEN_TYPE_FUNC_SINH] = TOKEN_FLAG_PREFIX | TOKEN_FLAG_IMPL_MULT_BEFORE,
		[TOKEN_TYPE_FUNC_COSH] = TOKEN_FLAG_PREFIX | TOKEN_FLAG_IMPL_MULT_BEFORE,
		[TOKEN_TYPE_FUNC_TANH] = TOKEN_FLAG_PREFIX | TOKEN_FLAG_IMPL_MULT_BEFORE,
		[TOKEN_TYPE_FUNC_LN] = TOKEN_FLAG_PREFIX | TOKEN_FLAG_IMPL_MULT_BEFORE,
		[TOKEN_TYPE_FUNC_LOG] = TOKEN_FLAG_PREFIX | TOKEN_FLAG_IMPL_MULT_BEFORE,
		[TOKEN_TYPE_FUNC_SQRT] = TOKEN_FLAG_PREFIX | TOKEN_FLAG_IMPL_MULT_BEFORE,
		[TOKEN_TYPE_FUNC_FACT] = TOKEN_FLAG_POSTFIX,
		[TOKEN_TYPE_FUNC_ABS] = TOKEN_FLAG_SURROUND | TOKEN_FLAG_IMPL_MULT_BEFORE,
		[TOKEN_TYPE_PAREN_OPEN] = TOKEN_FLAG_BEGIN_SCOPE | TOKEN_FLAG_IMPL_MULT_BEFORE,
		[TOKEN_TYPE_PAREN_CLOSE] = TOKEN_FLAG_END_SCOPE | TOKEN_FLAG_IMPL_MULT_AFTER,
		[TOKEN_TYPE_VAR] = TOKEN_FLAG_NONE | TOKEN_FLAG_IMPL_MULT_BEFORE,
		[TOKEN_TYPE_NUM] = TOKEN_FLAG_NONE | TOKEN_FLAG_IMPL_MULT_AFTER,
};
