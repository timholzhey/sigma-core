...
void derive_transform_init() {
	pattern_registry_add_rule(&derive_registry, "DERIVE_CONST_ADD", "ADD,(NUM),(ANY) > $2");
	pattern_registry_add_rule(&derive_registry, "DERIVE_CONST_SUB", "SUB,(NUM),(ANY) > $2");
	pattern_registry_add_rule(&derive_registry, "DERIVE_VAR", "VAR > [NUM=1]");
	// pattern_registry_add_rule(&derive_registry, "DERIVE_CONST", "NUM > [NUM=0]");
